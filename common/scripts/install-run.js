...
/******/ (() => {
      ...
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ trimNpmrcFileLines: () =>
            /* binding */ trimNpmrcFileLines,
          /* harmony export */
        });
        /* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! node:fs */ 973024);
        /* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_0___default =
          /*#__PURE__*/ __webpack_require__.n(
            node_fs__WEBPACK_IMPORTED_MODULE_0__,
          );
        /* harmony import */ var node_path__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! node:path */ 176760);
        /* harmony import */ var node_path__WEBPACK_IMPORTED_MODULE_1___default =
          /*#__PURE__*/ __webpack_require__.n(
        ...
        function _trimNpmrcFile(options) {
          ...
          if (
            node_fs__WEBPACK_IMPORTED_MODULE_0__.existsSync(sourceNpmrcPath)
          ) {
            npmrcFileLines.push(
              ...node_fs__WEBPACK_IMPORTED_MODULE_0__
          ...
          const resultLines = trimNpmrcFileLines(
            npmrcFileLines,
            process.env,
            supportEnvVarFallbackSyntax,
          );
        ...
        function _copyAndTrimNpmrcFile(options) {
          ...
          node_fs__WEBPACK_IMPORTED_MODULE_0__.writeFileSync(
            targetNpmrcPath,
            combinedNpmrc,
          );
          return combinedNpmrc;
        ...
        function syncNpmrc(options) {
          ...
          const sourceNpmrcPath = node_path__WEBPACK_IMPORTED_MODULE_1__.join(
            sourceNpmrcFolder,
            !useNpmrcPublish ? ".npmrc" : ".npmrc-publish",
          );
          const targetNpmrcPath = node_path__WEBPACK_IMPORTED_MODULE_1__.join(
            targetNpmrcFolder,
            ".npmrc",
          );
          try {
            if (
              node_fs__WEBPACK_IMPORTED_MODULE_0__.existsSync(
                sourceNpmrcPath,
              ) ||
              createIfMissing
            ) {
              ...
              if (
                ...
                node_fs__WEBPACK_IMPORTED_MODULE_0__.mkdirSync(
                  targetNpmrcFolder,
                  { recursive: true },
                );
              }
              ...
              node_fs__WEBPACK_IMPORTED_MODULE_0__.existsSync(targetNpmrcPath)
            ) {
        ...
        function isVariableSetInNpmrcFile(
          sourceNpmrcFolder,
          variableKey,
          supportEnvVarFallbackSyntax,
        ) {
  ...
  \*******************************************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony export */ __webpack_require__.d(__webpack_exports__, {
      /* harmony export */ RUSH_JSON_FILENAME: () =>
        /* binding */ RUSH_JSON_FILENAME,
      /* harmony export */ findRushJsonFolder: () =>
        /* binding */ findRushJsonFolder,
      /* harmony export */ getNpmPath: () => /* binding */ getNpmPath,
      /* harmony export */ installAndRun: () => /* binding */ installAndRun,
      /* harmony export */ runWithErrorAndStatusCode: () =>
        /* binding */ runWithErrorAndStatusCode,
      /* harmony export */
    });
    /* harmony import */ var node_child_process__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(/*! node:child_process */ 731421);
    /* harmony import */ var node_child_process__WEBPACK_IMPORTED_MODULE_0___default =
      /*#__PURE__*/ __webpack_require__.n(
        node_child_process__WEBPACK_IMPORTED_MODULE_0__,
      );
    /* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(/*! node:fs */ 973024);
    /* harmony import */ var node_fs__WEBPACK_IMPORTED_MODULE_1___default =
      /*#__PURE__*/ __webpack_require__.n(node_fs__WEBPACK_IMPORTED_MODULE_1__);
    /* harmony import */ var node_os__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(/*! node:os */ 848161);
    /* harmony import */ var node_os__WEBPACK_IMPORTED_MODULE_2___default =
      /*#__PURE__*/ __webpack_require__.n(node_os__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */ var node_path__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(/*! node:path */ 176760);
    /* harmony import */ var node_path__WEBPACK_IMPORTED_MODULE_3___default =
      /*#__PURE__*/ __webpack_require__.n(
        node_path__WEBPACK_IMPORTED_MODULE_3__,
      );
    /* harmony import */ var _utilities_npmrcUtilities__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(/*! ../utilities/npmrcUtilities */ 832286);
    // Copyright (c) Microsoft Corporation. All rights reserved. Licensed under the MIT license.
    // See LICENSE in the project root for license information.
    ...
    function getNpmPath() {
      if (!_npmPath) {
        try {
          if (_isWindows()) {
            // We're on Windows
            const whereOutput = node_child_process__WEBPACK_IMPORTED_MODULE_0__
              .execSync("where npm", { stdio: [] })
              .toString();
            const lines = whereOutput
              .split(node_os__WEBPACK_IMPORTED_MODULE_2__.EOL)
              .filter((line) => !!line);
            ...
            _npmPath = node_child_process__WEBPACK_IMPORTED_MODULE_0__
    ...
    function _ensureFolder(folderPath) {
      if (!node_fs__WEBPACK_IMPORTED_MODULE_1__.existsSync(folderPath)) {
        const parentDir =
          node_path__WEBPACK_IMPORTED_MODULE_3__.dirname(folderPath);
    ...
    function _ensureAndJoinPath(baseFolder, ...pathSegments) {
      ...
      try {
        for (let pathSegment of pathSegments) {
          ...
          joinedPath = node_path__WEBPACK_IMPORTED_MODULE_3__.join(
            joinedPath,
            pathSegment,
          );
        ...
        throw new Error(
          `Error building local installation folder (${node_path__WEBPACK_IMPORTED_MODULE_3__.join(baseFolder, ...pathSegments)}): ${e}`,
        );
      }
      return joinedPath;
    }
    ...
    function _resolvePackageVersion(
      ...
      if (version.match(/^[a-zA-Z0-9\-\+\.]+$/)) {
        ...
        try {
          ...
          const sourceNpmrcFolder = node_path__WEBPACK_IMPORTED_MODULE_3__.join(
            rushCommonFolder,
            "config",
            "rush",
          );
          ...
          const npmVersionSpawnResult =
            node_child_process__WEBPACK_IMPORTED_MODULE_0__.spawnSync(
              platformNpmPath,
              [
                "view",
                `${name}@${version}`,
    ...
    function findRushJsonFolder() {
      if (!_rushJsonFolder) {
        ...
        do {
          const testRushJsonPath = node_path__WEBPACK_IMPORTED_MODULE_3__.join(
            basePath,
            RUSH_JSON_FILENAME,
          );
          if (
            node_fs__WEBPACK_IMPORTED_MODULE_1__.existsSync(testRushJsonPath)
          ) {
          ...
          basePath !==
          (tempPath = node_path__WEBPACK_IMPORTED_MODULE_3__.dirname(basePath))
    ...
    function _isPackageAlreadyInstalled(packageInstallFolder) {
      try {
        const flagFilePath = node_path__WEBPACK_IMPORTED_MODULE_3__.join(
        ...
        const fileContents = node_fs__WEBPACK_IMPORTED_MODULE_1__
          .readFileSync(flagFilePath)
          .toString();
    ...
    function _cleanInstallFolder(
      ...
      try {
        const flagFile = node_path__WEBPACK_IMPORTED_MODULE_3__.resolve(
          packageInstallFolder,
          INSTALLED_FLAG_FILENAME,
        );
        _deleteFile(flagFile);
        const packageLockFile = node_path__WEBPACK_IMPORTED_MODULE_3__.resolve(
          packageInstallFolder,
          "package-lock.json",
        );
        if (lockFilePath) {
          node_fs__WEBPACK_IMPORTED_MODULE_1__.copyFileSync(
            lockFilePath,
            packageLockFile,
          );
        } else {
          ...
          const nodeModulesFolder =
            node_path__WEBPACK_IMPORTED_MODULE_3__.resolve(
              packageInstallFolder,
              NODE_MODULES_FOLDER_NAME,
            );
          if (
            node_fs__WEBPACK_IMPORTED_MODULE_1__.existsSync(nodeModulesFolder)
          ) {
            const rushRecyclerFolder = _ensureAndJoinPath(
              rushTempFolder,
              "rush-recycler",
            );
            node_fs__WEBPACK_IMPORTED_MODULE_1__.renameSync(
              nodeModulesFolder,
              node_path__WEBPACK_IMPORTED_MODULE_3__.join(
                rushRecyclerFolder,
    ...
    function _createPackageJson(packageInstallFolder, name, version) {
      try {
        ...
        const packageJsonPath = node_path__WEBPACK_IMPORTED_MODULE_3__.join(
          packageInstallFolder,
          PACKAGE_JSON_FILENAME,
        );
        node_fs__WEBPACK_IMPORTED_MODULE_1__.writeFileSync(
          packageJsonPath,
    ...
    function _getBinPath(packageInstallFolder, binName) {
      const binFolderPath = node_path__WEBPACK_IMPORTED_MODULE_3__.resolve(
        packageInstallFolder,
        NODE_MODULES_FOLDER_NAME,
        ".bin",
      );
      const resolvedBinName = _isWindows() ? `${binName}.cmd` : binName;
      return node_path__WEBPACK_IMPORTED_MODULE_3__.resolve(
        binFolderPath,
        resolvedBinName,
      );
    }
    ...
    function _getPlatformPath(platformPath) {
      return _isWindows() && platformPath.includes(" ")
        ? `"${platformPath}"`
        : platformPath;
    }
    function _isWindows() {
    ...
    function installAndRun(
      ...
      const rushCommonFolder = node_path__WEBPACK_IMPORTED_MODULE_3__.join(
        rushJsonFolder,
        "common",
      );
      const rushTempFolder = _getRushTempFolder(rushCommonFolder);
      ...
      try {
        ...
        process.env.PATH = [binFolderPath, originalEnvPath].join(
          node_path__WEBPACK_IMPORTED_MODULE_3__.delimiter,
        );
        result = node_child_process__WEBPACK_IMPORTED_MODULE_0__.spawnSync(
          platformBinPath,
          packageBinArgs,
          {
            stdio: "inherit",
